...
/*
token = diambil dari gabungan tanggal transaski dan nomor random
noResi = nomor resi yang telah d set d form pembayaran
bayar = biaya rekening yang harus dibayar
dibayar = biaya yang dibayar pelanggan
pel_no = nomor rekening
noRek = nomor rekening yang akan dibayar
_User = pengguna aplikasi
_IP = ip pengguna
*/			
