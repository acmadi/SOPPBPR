...
<?php
	...
	ORDER BY a.kp_nama,a.byr_tgl,getberjalan(a.byr_tgl,a.rek_bln,a.rek_thn),IFNULL(b.kar_nama,'PT POS'),a.rek_thn,a.rek_bln,a.pel_no";
	$que	= mysql_query($sql) or die(errorHD::salahDB(array(mysql_errno(),mysql_error(),$sql)));
?>
<center>
	<b>
		LAPORAN PENERIMAAN PENAGIHAN (LPP)
		<br/>(RINCI SELURUH PENERIMA KAS)
	</b>
</center>
<br/>			
...
?>								<tr>
									...
									<td bgcolor="white" align="left"><font size='2'><?=$row0['kar_id']?></td>
...
?>					<tr>
						...
						<td bgcolor="#c0c0c0"></td>
						<td bgcolor="#c0c0c0"></td>
						<td bgcolor="#c0c0c0" align="center"><font size='3'><?=number_format(sprintf("%d",$baris))?></td>
						<td bgcolor="#c0c0c0"></td>
						<td bgcolor="#c0c0c0"></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($uangair_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($adm_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($meter_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($angsuran_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($total_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($denda_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",array_sum($materai_rek_bln)))?></td>
						<td bgcolor="#c0c0c0" align="right"><font size='3'><?=number_format(sprintf("%d",$total_sep))?></td>
						<td bgcolor="#c0c0c0"></td>
					</tr>
<?
					$baris=null;
...
?>				<tr>
					<td colspan ="3" bgcolor="#c0c0c0"><font size='3'><b>Total Per Tanggal</b></font></td>
					<td bgcolor="#c0c0c0" align="center"><font size='3'><b><?=number_format(sprintf("%d",$baris_hr))?></td>
					<td bgcolor="#c0c0c0"></td>
					<td bgcolor="#c0c0c0"></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($uangair_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($adm_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($meter_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($angsuran_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($total_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($denda_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($materai_rek_har)))?></b></font></td>
					<td bgcolor="#c0c0c0" align="right"><font size='3'><b><?=number_format(sprintf("%d",$total_hr))?></b></font></td>
					<td bgcolor="#c0c0c0"></td>
				</tr>
<?
				$baris_hr=null;
...
?>			<tr>
				<td colspan ="3" bgcolor='#CC66FF'><font size='3'><b><?echo "Total Kopel : $row0[kp_nama]"?></font></td>
				<td bgcolor="#CC66FF" align="center"><font size='2'><b><?=number_format(sprintf("%d",$baris_kpl))?></td>
				<td bgcolor="#CC66FF"></td>
				<td bgcolor="#CC66FF"></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($uangair_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($adm_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($meter_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($angsuran_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($total_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($denda_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($materai_rek_kpl)))?></font></td>
				<td bgcolor="#CC66FF" align="right"><font size='3'><b><?=number_format(sprintf("%d",$total_kpl))?></b></font></td>
				<td bgcolor="#CC66FF"></td>
			</tr>
<?
			$baris_kpl=null;
...
?>
		<tr>
			<td colspan="3" bgcolor="#FFFF99"><font size='3'><b>GRANDTOTAL</b></font></td>
			<td bgcolor="#FFFF99" align="center"><font size='3'><b><?=number_format(sprintf("%d",$baris_seluruh))?></td>
			<td bgcolor="#FFFF99"></td>
			<td bgcolor="#FFFF99"></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($uangair_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($adm_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($meter_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($angsuran_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($total_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($denda_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",array_sum($materai_tot)))?></b></font></td>
			<td bgcolor="#FFFF99" align="right"><font size='3'><b><?=number_format(sprintf("%d",$total_seluruh))?></b></font></td>
			<td bgcolor="#FFFF99"></td>
		</tr>
<?
		$baris_seluruh=null;
